 ...
 */
public abstract class ComponentModel<R, N extends PageModel<? super N>, C extends ComponentModel<? super R, N, ? super C>> extends WebElementTester<R, N> {
	...
	public ComponentModel(ClickAction<?, N> clickAction) {
		super(clickAction);
	}
	...
	protected WebElement findComponentElement(By by) {
		...
		try {
			...
			return new LocatedWebElement(el, by, element);
		} catch (Exception e) {
			return new LocatedWebElement(null, by, element);
		}
	}
	...
	protected List<WebElement> findComponentElements(By by) {
		...
		try {
			...
			return Arrays.asList(new LocatedWebElement(null, by, element));
		}
	}
